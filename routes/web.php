...
Route::prefix('{locale}')
    ...
    ->group(function (): void {
        ...
        Route::get('/products', fn (string $locale) => redirect()->to(route('home', ['locale' => $locale]).'#shop'))->name('products');
        Route::get('/gallery', fn (string $locale) => redirect()->to(route('home', ['locale' => $locale]).'#shop'))->name('gallery');
